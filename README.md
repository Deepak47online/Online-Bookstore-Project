...
In this project, I analyzed a structured dataset using advanced SQL querying techniques to extract meaningful business insights. I performed end-to-end data exploration, cleaning, transformation, and insight generation by applying a wide range of SQL functions and operations.

Key tasks included filtering data, aggregating metrics, identifying trends, and generating summary reports.
